    ...
    <div dir='rtl' className='py-20 px-4 sm:px-[5vw] md:px-[7vw] lg:px-[9vw]'>
        ...
        <div className='flex mt-20 w-full gap-10 items-center'>
            <div className='flex justify-between items-center w-[50%]'>
                <div className=''>
                    <h5 className='text-[#0055D2] text-xl font-bold mb-6'>مدربين و مدرسين معتمدون</h5>
                    <h1 className='text-2xl font-bold mb-4'> نقدم لك الدعم والمتابعة اللازمة للوصول معًا إلى أفضل النتائج.</h1>
                    ...
                    <button className='flex gap-3 items-center bg-[#0055D2] py-3 px-6 border rounded-xl text-white'>اعرف المزيد<img src={whiteArrow}/></button>
                </div>
