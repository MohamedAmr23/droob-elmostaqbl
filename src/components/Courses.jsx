...
const Courses = () => {
  ...
  return (
    <div dir="rtl" className="bg-[#F8FBFB] py-20 px-4 sm:px-[5vw] md:px-[7vw] lg:px-[9vw]">
      <div className="text-center">
        <h1 className="font-bold mt-5 text-2xl sm:text-3xl"> أحدث الدورات التدريبية </h1>
      ...
      <div className='text-center mt-10'>
        <button className='bg-[#0055D2] p-2 px-6 rounded-3xl text-white'>عرض جميع الكورسات</button>
      </div>
    </div>
  );
};
