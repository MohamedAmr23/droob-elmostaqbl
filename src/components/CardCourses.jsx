...
const CardCourses = ({ icon, name, desc, button, img, price, date }) => {
  return (
    <div dir="rtl" className='bg-[#ffffff] w-full sm:w-[300px] shadow-md rounded-xl'>
      <img src={icon} alt='' className='rounded-t-xl h-[200px] sm:h-[180px] w-full'/>
      <div className='flex flex-col gap-3 mt-4 px-4'>
        ...
        <div className='flex gap-2 items-center justify-between mb-3'>
          <p className='text-[#616161] text-xs sm:text-sm text-nowrap'>{date}</p>
